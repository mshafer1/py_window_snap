...
def main(verbosity: int, store_current: bool, force: bool):
    ...
    if store_current:
        ...
        with open(config_path, "w") as f:
            print("# window-snap configuration file", file=f)
            print("# This file is automatically generated by window-snap", file=f)
            print("# Edit this file to change window positions and sizes", file=f)
            print("# See https://mshafer1.github.io/window-snap/ for more information", file=f)
            print("#", file=f)
            yaml.dump(
                {
